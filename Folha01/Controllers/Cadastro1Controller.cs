...
{
    public class Cadastro1Controller : Controller
    {
        private readonly Context _context;

        public Cadastro1Controller(Context context)
        {
            _context = context;
        }
        ...
        // GET: Cadastro1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Cadastro1/Create
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("IdFuncionario,NomeFuncionario,Cpf,Cep,DatadeNascimento,Gmail")] CadastroFModel cadastroFModel)
        {
        ...
        // POST: Cadastro1/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdFuncionario,NomeFuncionario,Cpf,Cep,DatadeNascimento,Gmail")] CadastroFModel cadastroFModel)
        {
